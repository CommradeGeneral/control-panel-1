...
\begin{drawingpage}[title = {Control Panel layout}]
	\node [scale =0.77,rotate = 90] at (paper center) {\includegraphics[scale=1]{drawings/Board 3.pdf}};
\end{drawingpage}
...
\begin{drawingpage}[title = {Motor Drive wiring}]
	\node [scale =0.9] at (paper center) {\includegraphics[scale=1]{drawings/2- Drive Circuits(proj 3 - 1 - 1).pdf}};
\end{drawingpage}
...
\begin{drawingpage}[title = {main board wiring(semi-auto)}]
	\node [scale =0.9] at (paper center) {\includegraphics[scale=1]{drawings/4- artronic.pdf}};
\end{drawingpage}
